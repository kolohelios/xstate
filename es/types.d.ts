...
export interface ActionFunction<TContext, TEvent extends EventObject> {
    (context: TContext, event: OmniEventObject<TEvent>, meta: ExecMeta<TContext, TEvent>): any | void;
    name: string;
}
...
export declare type TransitionsConfig<TContext, TEvent extends EventObject> = {
    [K in TEvent['type'] | BuiltInEvent<TEvent>['type']]?: string | number | StateNode<TContext> | TransitionConfig<TContext, TEvent extends {
        type: K;
